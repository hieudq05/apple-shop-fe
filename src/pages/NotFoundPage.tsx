    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center px-4">
            <div className="max-w-md w-full text-center">
                {/* Apple Logo */}
                <div className="mb-8">
                    <svg height="80" viewBox="0 0 14 44" width="32" xmlns="http://www.w3.org/2000/svg" className="mx-auto">
                        <path
                ...
                <div className="mt-8 text-sm text-gray-500">
                    ...
                    <p className="mt-1">
                        ...
                        {' hoặc '}
                        <a href="mailto:support@appleshop.vn" className="text-blue-600 hover:underline">
