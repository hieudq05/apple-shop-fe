...
const RegisterPage: React.FC = () => {
    ...
    const handleGoogleRegister = async (credentialResponse: any) => {
        ...
        try {
            ...
            setErrors([
                error.response?.data?.message || "Đăng ký bằng Google thất bại",
            ]);
        }
    };
    ...
    return (
        <>
            ...
            <div
                className={
                    "mx-auto container  px-20 max-w-7xl w-[40rem] lg:w-[50rem]"
                }
            >
                <div
                    aria-label={"Title"}
                    className={
                        "md:text-5xl text-3xl font-semibold text-center md:py-12 py-6"
                    }
                >
                ...
                <div className={"flex w-full h-fit space-x-12"}>
                    ...
                    >
                        <div
                            className={
                                "text-2xl font-semibold text-center text-muted-foreground"
                            }
                        >
                        ...
                        <form onSubmit={handleRegister} className="space-y-4">
                            ...
                            <div className="flex">
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        className={
                                            "w-full text-lg px-4 pb-3 pt-6 border rounded-xl rounded-br-none rounded-tr-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition"
                                        }
                                    />
                                </div>
                                <div
                                    className={
                                        "relative flex-1 top-0 left-[-1px] z-0"
                                    }
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        className={
                                            "w-full text-lg px-4 pb-3 pt-6 border border-s-0 rounded-xl rounded-bl-none rounded-ss-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition"
                                        }
                                    />
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <input
                                    ...
                                    onFocus={() =>
                                        document
                                            .getElementById("birth-container")
                                            ?.classList.add("z-10")
                                    }
                                    onBlur={() =>
                                        document
                                    ...
                                    className={
                                        "w-full text-lg px-4 pb-3 pt-6 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition"
                                    }
                                />
                            </div>
                            ...
                            <button
                                ...
                                disabled={isLoading}
                                className={
                                    "py-4 w-full flex gap-2 justify-center items-center rounded-xl bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-200 transition disabled:opacity-50"
                                }
                            >
                        ...
                        <div
                            className={"flex flex-col gap-4 items-center pb-24"}
                        >
